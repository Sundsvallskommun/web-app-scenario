...
export const useCrudHelper = (resource: string) => {
  ...
  const handleGetOne = useCallback(
    async <TData = unknown>(getOne: () => ResourceResponse<TData>): Promise<TData | undefined> => {
  ...
  const handleGetMany = useCallback(
    async <TData = unknown>(getMany: () => ResourceResponse<TData[]>): Promise<TData[] | undefined> => {
  ...
  const handleCreate = useCallback(
    async <TData = unknown>(create: () => ResourceResponse<TData>): Promise<TData | undefined> => {
      const name = t(`${resource}:name_one`);
      try {
  ...
  const handleUpdate = useCallback(
    async <TData = unknown>(update: () => ResourceResponse<TData>): Promise<TData | undefined> => {
      const name = t(`${resource}:name_one`);
      try {
  ...
  const handleRemove = useCallback(
    async <TData = unknown>(remove: () => ResourceResponse<TData>): Promise<TData | undefined> => {
      const name = t(`${resource}:name_one`);
      try {
